            ...
            <form onSubmit={handleSubmit(handleClick)}>
              <FormRow>
                <FormGroup>
                  <Label>Tên cột(*)</Label>
                  <TextField
                    error={error?.templateHeaders?.name ? true : false}
                    helperText={error?.templateHeaders?.name}
                    name="name"
                    placeholder="Ex: MSSV"
              ...
              <FormRow>
                ...
                {isCriteria ? (
                  <FormGroup>
                    ...
                    <TextField
                      error={error?.templateHeaders?.totalPoint ? true : false}
                      helperText={error?.templateHeaders?.totalPoint}
                      type="number"
                      name="totalPoint"
                      placeholder="Ex: 30"
                      InputProps={{
